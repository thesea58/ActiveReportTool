...
/// </summary>
public partial class KP011120Controls
{
    ...
    public void ExtractSection3Controls()
    {
        ...
        var field6 = section3.Controls["Field6"] as TextBox;
        var field7 = section3.Controls["Field7"] as TextBox;
        var field9 = section3.Controls["Field9"] as TextBox;
        var field13 = section3.Controls["Field13"] as TextBox;
        var field14 = section3.Controls["Field14"] as TextBox;
        var 予算増1 = section3.Controls["予算増1"] as TextBox;
        var 予算細名称減1 = section3.Controls["予算細名称減1"] as TextBox;
        var 予算細名称増1 = section3.Controls["予算細名称増1"] as TextBox;
        var 所属名称減1 = section3.Controls["所属名称減1"] as TextBox;
        var 所属減1 = section3.Controls["所属減1"] as TextBox;
        var 所属名称増1 = section3.Controls["所属名称増1"] as TextBox;
        var 所属増1 = section3.Controls["所属増1"] as TextBox;
        var field1 = section3.Controls["Field1"] as TextBox;
    }
